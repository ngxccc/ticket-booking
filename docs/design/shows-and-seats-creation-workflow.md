...
| **1.2.1** | Batch Generator | L3: Logic | Expand date range & time slots into show instances | `src/modules/shows/dto/create-show-batch.dto.ts` |
| 1.2.1.1 | All-or-Nothing Transaction | L4: Execution | Single DB transaction; rollback on any collision | `src/modules/shows/shows.service.ts` |
